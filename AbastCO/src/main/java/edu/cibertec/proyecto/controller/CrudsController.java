...
public class CrudsController {
	...
	public ModelAndView crudListProveedores(Pageable pageable, @RequestParam(name="page",defaultValue = "0")int page) {
		ModelAndView mav = new ModelAndView("crudProveedores");
		mav.addObject("paquetePv",proveedoresService.listar(pageable));
		mav.addObject("page", page);
		return mav;
	}
	...
	public ModelAndView crudEliminarProveedor(@RequestParam(name="idpro")int idpro,Pageable pageable) {
		ModelAndView mav=new ModelAndView("crudProveedores");
	...
	public ModelAndView crudInvocarEditProducto(@RequestParam(name = "idprod")int idprod,Pageable pageable) {
	...
	public ModelAndView crudCrearProducto(Pageable pageable) {
	...
	public String crusEjecutarCrearCliente(@Valid @ModelAttribute (name = "PaqueteC") ClienteEntity obj, BindingResult result) {
		...
		return "redirect:/crud_Clientes?page=0&size=10";
	}
	...
	public String crusEjecutarCrearProveedor(@ModelAttribute (name = "PaquetePv") ProveedorEntity obj) {
		...
		return "redirect:/crud_Proveedores?page=0&size=10";
	}
